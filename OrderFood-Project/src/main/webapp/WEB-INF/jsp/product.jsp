	                                            ...
	                                            <div class="single-product">
	                                                ...
	                                                <div class="pro-content">
	                                                    <div class="pro-info">
	                                                        ...
	                                                        <p><span class="price">${product.price} vnđ</span><del class="prev-price">$400.50</del></p>
	                                                        <div class="label-product l_sale">30<span class="symbol-percent">%</span></div>
	                                                    </div>
	                                                    <div class="pro-actions">
	                                                        ...
	                                                        <div class="actions-secondary">
	                                                            <a href="compare.html" title="Compare"><i class="lnr lnr-sync"></i> <span>Thêm vào so sánh</span></a>
	                                                            <a href="wishlist.html" title="WishList"><i class="lnr lnr-heart"></i> <span>Thêm vào WishList</span></a>
	                                                        </div>
	                                                    </div>
	                                                </div>
	                                                <!-- Product Content End -->
