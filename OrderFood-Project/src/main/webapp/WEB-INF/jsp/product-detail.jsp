                            ...
                            <div class="thubnail-desc fix">
                                ...
                                <div class="rating-summary fix mtb-10">
                                    ...
                                    <div class="rating-feedback">
                                        <a href="#">(1 review)</a>
                                        <a href="#">Thêm vào bài đánh giá của bạn</a>
                                    </div>
                                </div>
                                <div class="pro-price mtb-30">
                                    <p class="d-flex align-items-center"><span class="prev-price">16.51</span><span class="price">${product.price}</span><span class="saving-price">tiết kiệm 8%</span></p>
                                </div>
                                ...
                                <div class="box-quantity d-flex hot-product2">
                                    ...
                                    <div class="pro-actions">
                                        ...
                                        <div class="actions-secondary">
                                            <a href="compare.html" title="" data-original-title="Compare"><i class="lnr lnr-sync"></i> <span>Thêm vào để so sánh</span></a>
                                            <a href="wishlist.html" title="" data-original-title="WishList"><i class="lnr lnr-heart"></i> <span>Thêm vào WishList</span></a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="main-thumb-desc nav tabs-area" role="tablist">
                            <li><a class="active" data-toggle="tab" href="#dtail">Thông tin chi tiết sản phẩm</a></li>
