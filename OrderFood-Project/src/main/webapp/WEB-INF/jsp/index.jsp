            ...
            <div class="header-top-area">
                <div class="container">
                    ...
                    <div class="header-top">
                        <ul>
                            <li><a href="#">Giao hàng miễn phí cho đơn hàng trên 100k</a></li>
                        ...
                        <ul>                                          
                            <li><span>Ngôn ngữ</span> <a href="#">Tiếng Việt<i class="lnr lnr-chevron-down"></i></a>
                                ...
                                <ul class="ht-dropdown">
                                    <li><a href="#"><img src="/img/header/1.jpg" alt="language-selector">Tiếng Việt</a></li>
                                    <li><a href="#"><img src="/img/header/2.jpg" alt="language-selector">English</a></li>
                                </ul>
                                <!-- Dropdown End -->
                            </li>
                            <li><span>Tiền Tệ</span><a href="#"> VNĐ <i class="lnr lnr-chevron-down"></i></a>
                                <!-- Dropdown Start -->
                                <ul class="ht-dropdown">
                                    <li><a href="#">VNĐ</a></li>
                                    <li><a href="#">&#36; USD</a></li>
                        ...
                        <div class="col-lg-5 col-md-8 ml-auto mr-auto col-10">
                            <div class="categorie-search-box">
                                <form action="#">
                                    ...
                                    <input type="text" name="search" placeholder="Tôi muốn mua sắm...">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="cart-box mt-all-30">
                                <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                                    <li><a href="/shopping-cart/cart-item?user_id=a8f17b3f-0fe1-4e9f-996e-bf4807e9cffa"><i class="lnr lnr-cart"></i><span class="my-cart"><span class="total-pro">2</span><span>Giỏ Hàng</span></span></a>
                                    ...
                                    <li><a href="/user/login"><i class="lnr lnr-user"></i><span class="my-cart"><span> <strong>Đăng Nhập</strong> </span><span> Tham gia</span></span></a>
                ...
                <div class="vertical-menu mt-30">
                    ...
                    <nav>  
                        <div id="cate-mobile-toggle" class="category-menu sidebar-menu sidbar-style mobile-categorei-menu-list menu-hidden ">
                            <ul>
                            	<c:forEach var="category" items="${cateogries_items_list}">
                        ...
                        <div class="vertical-menu mb-all-30">
                            <nav>
                                <ul class="vertical-menu-list">
                                	...
                                	<c:forEach var="category" items="${cateogries_items_list}">
                                		<li><a href="shop.html"><span><img src="/img/vertical-menu/3.png" alt="menu-icon"></span> ${category.name} <i class="fa fa-angle-right" aria-hidden="true"></i></a>
	                                        ...
	                                        <ul class="ht-dropdown megamenu first-megamenu">
	                                            ...
	                                            <c:forEach var="item" items="${category.items}">
	                                            	<li class="single-megamenu">
		                                                <ul>
		                                                    <li class="menu-tile"> <a href="/product/item?id=${item.itemId}"> ${item.itemName} </a></li>
                         ...
                         <div class="col-xl-7 col-lg-7 ml-auto mr-auto col-md-8">
                            <div class="news-desc text-center mb-30">
                             ...
                             <div class="newsletter-box">
                                 <form action="#">
                                      <input class="subscribe" placeholder="Nhập địa chỉ email của bạn vào đây" name="email" id="subscribe" type="text">
                            ...
                            <div class="single-footer mb-sm-40">
                                ...
                                <div class="footer-content">
                                    <ul class="footer-list address-content">
                                        <li><i class="lnr lnr-map-marker"></i> Địa Chỉ: 169-C, Technohub, Dubai Silicon Oasis.</li>
                                        <li><i class="lnr lnr-envelope"></i><a href="#"> Gửi Thư Cho Chúng Tôi: Support@Truemart.Com </a></li>
                                        <li><i class="lnr lnr-phone-handset"></i> Điện Thoại: (+800) 123 456 789)</li>
                                    </ul>
            ...
            <div class="footer-bottom pb-30">
                <div class="container">
                     ...
                     <div class="copyright-text text-center">                    
                        <p>Bản quyền © 2018 <a target="_blank" href="#">Truemart</a> Mọi quyền được bảo lưu.</p>
                     </div>
                </div>
                <!-- Container End -->
            </div>
