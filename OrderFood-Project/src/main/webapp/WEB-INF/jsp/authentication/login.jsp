                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="cart-box mt-all-30">
                                <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-user"></i><span class="my-cart"><span> <strong>Đăng Nhập</strong> </span><span> Tham gia</span></span></a>
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li><a href="/user/login">Tài Khoản</a></li>
                        <li class="active"><a href="/user/login">Đăng Nhập</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
                    ...
                    <div class="col-md-6">
                        <div class="well mb-sm-30">
                            <div class="new-customer">
                                ...
                                <a class="customer-btn" href="register.html">Đăng ký ngay</a>
                            </div>
                        </div>
                    </div>
                    <!-- New Customer End -->
